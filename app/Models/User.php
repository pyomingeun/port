...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'full_name','email','phone','profile_pic','profile_setup_step','hotel_id','password','access','created_at','updated_at', 'hotel_id','forgot_password_code','social_id','access_token', 'refresh_token', 'fcm_token', 'expires_in','signup_by','status','set_password_code','created_by','updated_by','change_email_verification_code',' new_email_for_change','total_rewards_points','is_loging','last_activity_at', 'agree_required', 'agree_forever', 'agree_message'
    ];
