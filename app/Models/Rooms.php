...
class Rooms extends Model
{
    ...
    protected $fillable = [
        'hotel_id','slug','no_of_bathrooms','room_name', 'room_size', 'room_featured_img', 'room_description', 'standard_occupancy_adult','standard_occupancy_child', 'maximum_occupancy_adult', 'maximum_occupancy_child', 'standard_price_weekday','standard_price_weekend', 'standard_price_peakseason', 'extra_guest_fee', 'basic_info_status', 'beds_status',	'roomfnf_status', 'pricing_status', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'
    ];
