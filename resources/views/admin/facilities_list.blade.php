    ...
    <div class="main-wrapper-gray">
        ...
        <div class="content-box-right earnings-payouts-sec">
            <div class="container-fluid">
                <h5 class="h5  mb-3">Facilities Management</h5>
                <div class="heading-sec mb-4 d-flex align-items-center">
                    ...
                    <div class="filter-header-row ml-auto d-flex justify-content-end">
                        ...
                        <div class="filter-header-col filter-dd-wt-sd-lable">
                            <a class="btn h-36" href="{{route('facilities-input',0)}}">Add New Facilities</a>
                        </div>
                    </div>
                    </form>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="actionDropdown ">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item" href="{{route('facilities-input',$row->id)}}"><img src="{{asset('/assets/images/')}}/structure/edit.svg" alt="" class="editIcon"> Edit</a>
                                            </li>
                                            <li> 
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click','#userDelYes',function(){
                var i = $(this).attr('data-i');
                var url = "{{ route('facilities-status',['id'=>':i','status'=>'deleted'])}}";  
                url = url.replace(':i', i);
                window.location.href = url;
            });
        });    
