<button class="openSidebar-btn">click</button>
            ...
            <div class="sidebar-menu">
                <ul class="sidebar-menu-ul">
                    ...
                    <li class="nav-item {{ (Request::segment(1) =='coupon-list' || Request::segment(1) =='coupon-input')?'active':'' }}">
                        <a href="{{ route('coupon-list'); }}" class="nav-link"> <img src="{{asset('/assets/images/')}}/structure/coupon-codes.svg" alt="" class="sidebarIcon" />  {{ __('home.CouponControl') }}</a>
                    </li>
                    <li class="nav-item {{ (Request::segment(1) =='my-notifications' || Request::segment(1) =='notification-setting')?'active':'' }}">
                        <a href="{{ route('my-notifications'); }}" class="nav-link"> <img src="{{asset('/assets/images/')}}/structure/notifications.svg" alt="" class="sidebarIcon" />  {{ __('home.Notification') }}
                            <div class="number-counter">0</div>
                        </a>
                    </li>
                    <li class="nav-item {{ (Request::segment(1) =='my-payouts')?'active':'' }}">
                        <a href="{{ route('my-payouts'); }}" class="nav-link"> <img src="{{asset('/assets/images/')}}/structure/earnings-payouts.svg" alt="" class="sidebarIcon" />  {{ __('home.RevenueAndPayout') }}</a>
                    </li>
                    @endif
                </ul>
            </div>
