...
<head>
  ...
  <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/scss/jquery.Jcrop.min.css') }}" />
...
<body>
  ...
  <div class="alertDialog" id="commonErrorBox" style="display:none;">
    <p class="mb-0 alertmsinner-box alertDanger">
      ...
      <!-- <img src="{{ asset('/assets/images/') }}/structure/delete-circle-red.svg" class="delete-alert" /> -->
