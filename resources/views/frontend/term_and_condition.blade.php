            ...
            <div class="bannerContent">
                <nav aria-label="breadcrumb" class="breadcrumbNave on-banner-breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('home.termsAndConditions') }}</li>
                    </ol>
                </nav>
                <h5 class="h1 mb-0">{{ __('home.termsAndConditions') }}</h1>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-ld-12 col-md-12 col-sm-12 col-12">
                    <h5 class="h5">{{ __('home.loremtext') }}</h5>
