            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="registerForw">
                        ...
                        <h3 class="h3 mt-4 mb-4">{{$title}}</h3>
                        <p class="p1 mb-5">{{$message}}</p>
                        <button type="button" class="btn" href="#" data-bs-toggle="modal" data-bs-target=".loginDialog">{{ __('home.logIn') }}</button>
                    </div>
                </div>
                <!-- offer image div -->
